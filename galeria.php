...
If ($_REQUEST['csoport'] != "") { 
	...
	while ($next_element = mysql_fetch_array($result)){
		...
		$kepsor = $kepsor . '
						<a href="' . $eleres . $next_fajlnev_nagy . '" class="highslide" onclick="return hs.expand (this, {dimmingOpacity: 0.90})">
							<img src="' . $eleres . ''.$next_fajlnev_nagy . '" alt="" style="background-color: #ffffff; border: 1px solid #c5aa5f; margin: 10px 10px 10px 10px;" height="90" border="1" />
						</a>
	...
	if ($vancsoport == "1"){
	$galeriafejlec =
	'<div id="galeria-alfejlec"> '.$csoportszoveg.'
	</div>
	';
	...
	*/
	$visszagomb = '<a href="index.php?p=galeria&amp;csoport='.$visszacsoport.'&amp;lang='.$_SESSION["lang"].'" class="visszagomb">'.$vissza_felirat.'</a>';
	}
